...
Builder.prototype.beautify = function() {

  // TODO
  var opts = {
    indent_size: 2
  };
  this._result = jsbeautifier(this._result, opts);
  return this;
};
...
Builder.prototype.get = function(key) {
  ...
  return this.create().beautify().getResult();
};
...
Builder.prototype.export = function(filepath, encoding) {
  ...
  fs.writeFileSync(filepath, this._result, encode);
  return this;
};
